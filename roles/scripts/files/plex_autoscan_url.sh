...
readonly SERVER_IP=$(cat ${PAS_CONFIG} | jq -r .SERVER_IP)
readonly SERVER_PORT=$(cat ${PAS_CONFIG} | jq -r .SERVER_PORT)
readonly SERVER_PASS=$(cat ${PAS_CONFIG} | jq -r .SERVER_PASS)
