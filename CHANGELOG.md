...
- Added [SABnzbd](https://sabnzbd.org)
...
- [Plex Library](https://github.com/adamgot/python-plexlibrary): New role.
...
- [Telly](https://github.com/tombowditch/telly): Added new role (thanks [EnorMOZ](https://github.com/EnorMOZ)).
...
- [Nethogs](https://github.com/raboof/nethogs): Added new role (thanks [EnorMOZ](https://github.com/EnorMOZ)).
...
- Commmon: installs `netaddr` python module for Ansible's `ipv4` filter.
...
- [Dependency Installer Script](https://github.com/cloudbox/cloudbox/wiki/First-Time-Install%3A-Downloading-Cloudbox#1-install-dependencies): added into wiki.
...
- [Heimdall](https://heimdall.site/): New role (thanks [TheBradz](https://github.com/TheBradz)).
  ...
  - folder: `/opt/heimdall`
- HTTP Authentication support: See [here](https://github.com/Cloudbox/Cloudbox/wiki/HTTP-Auth-Support) for more details.
